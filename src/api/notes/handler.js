...
class NotesHandler {
    ...
    postNoteHandler(request, h) {
      ...
      try{
        ...
        const noteId = this._service.addNote({title, body, tags}); // Untuk proses memasukan catatan baru,Karena fungsi this._service.addNotes akan mengembalikan id catatan yang disimpan, maka buatlah variabel noteId untuk menampung nilainya
